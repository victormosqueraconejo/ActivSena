...
import './style/DetallesAlquiler.css';
...
import juegos_mesaImg from './img/juegos_mesa.jpg';
  ...
  return (
    <>
      <div className="detalles-alquiler-container">
        <section className="imagenes-representativas">
          ...
          <img src={juegos_mesaImg} alt="Imagen 3" className="imagen-representativa" />
